...
$secrets = @{
    ...
    "API_BASE_URL"="https://api.campdreamga.com"
    "APP_NAME"="myappai"
    ...
    "VITE_API_BASE_URL"="https://campdreamgacom-production.up.railway.app"
