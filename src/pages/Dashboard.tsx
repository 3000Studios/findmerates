  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex justify-between items-center mb-12">
        ...
        <button className="inline-flex items-center px-4 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {savedSearches.length > 0 ? savedSearches.map(s => (
                <div key={s.id} className="bg-white p-6 rounded-xl border border-slate-200 hover:border-brand-600 transition-all group">
                  ...
                  <button className="w-full py-2 bg-slate-50 text-slate-600 rounded-lg text-sm font-semibold group-hover:bg-brand-600 group-hover:text-white transition-all flex items-center justify-center gap-2">
